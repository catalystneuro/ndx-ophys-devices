...
# Next Steps for ndx-ophys-devices Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-ophys-devices directory: `cd ndx-ophys-devices`
...
`spec/ndx-ophys-devices.namespace.yaml` and
`spec/ndx-ophys-devices.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-ophys-devices
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/alessandratrapani/ndx-ophys-devices/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-ophys-devices/0.1.0
...
`staged-extensions/ndx-ophys-devices`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-ophys-devices
    ```

13. Edit `staged-extensions/ndx-ophys-devices/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/alessandratrapani/ndx-ophys-devices
      pip: https://pypi.org/project/ndx-ophys-devices/
      license: BSD-3
      maintainers: 
        - alessandratrapani
      ```

14. Edit `staged-extensions/ndx-ophys-devices/README.md`
to add information about your extension. You may copy it from
`ndx-ophys-devices/README.md`.

  ```bash
  cp ndx-ophys-devices/README.md staged-extensions/ndx-ophys-devices/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-ophys-devices
git commit -m "Add new catalog entry for ndx-ophys-devices" .
git push
```
...
ndx-ophys-devices-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-ophys-devices GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-ophys-devices-record repository on GitHub.
